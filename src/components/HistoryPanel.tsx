      ...
      <Card className="border border-white/5 shadow-2xl bg-zinc-900/80 backdrop-blur-xl rounded-[2rem] overflow-hidden">
        <CardContent className="p-2 sm:p-6 flex justify-center">
          <Calendar
            ...
            classNames={{
              day: "h-10 w-10 sm:h-12 sm:w-12 text-center text-sm p-0 relative rounded-xl hover:bg-white/10 transition-colors flex items-center justify-center mx-auto text-white",
              day_button: "h-full w-full p-0 font-medium flex items-center justify-center rounded-xl aria-selected:opacity-100",
              ...
              head_cell: "flex-1 text-zinc-500 font-black text-[10px] uppercase tracking-widest flex items-center justify-center",
              row: "flex w-full mt-2",
              cell: "flex-1 p-0 relative focus-within:relative focus-within:z-20 flex items-center justify-center",
              caption: "flex justify-center pt-1 relative items-center mb-4 w-full",
              caption_label: "text-lg font-black tracking-tight capitalize text-white",
              nav: "space-x-1 flex items-center",
              nav_button: "h-8 w-8 bg-zinc-800/80 hover:bg-zinc-700 hover:text-white rounded-lg transition-colors flex items-center justify-center text-zinc-400 border border-white/5",
